...
HMG 在 Community Edition 中暴露 8 個 MCP 工具。所有工具接受可選的 `context` 物件，包含範圍欄位以實現分支感知記憶。
...
![Agent 呼叫 memory_agent_brief](../img/agent-brief.png)
...
![Agent 呼叫 memory_stats](../img/agent-stats.png)
