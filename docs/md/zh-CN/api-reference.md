...
HMG 在 Community Edition 中暴露 8 个 MCP 工具。所有工具接受可选的 `context` 对象，包含作用域字段以实现分支感知记忆。
...
![Agent 调用 memory_agent_brief](../img/agent-brief.png)
...
![Agent 调用 memory_stats](../img/agent-stats.png)
