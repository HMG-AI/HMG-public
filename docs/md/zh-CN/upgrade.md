...
访问 [funcode.xin/HMG/#pricing](https://funcode.xin/HMG/#pricing) 购买 Developer 或 Enterprise 许可。

### 2. 应用 License Key

```bash
hmg license apply hmg-dev-xxxxxxxxxxxx.yyyyyyyyyyyy
```
...
- Website: [funcode.xin/HMG](https://funcode.xin/HMG/)
