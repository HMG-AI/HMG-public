...
![エージェントが memory_memorize を呼び出し](../img/agent-memorize.png)
...
![エージェントが memory_recall を呼び出し](../img/agent-recall.png)
...
![エージェントが memory_correct を呼び出し](../img/agent-correct.png)
...
![エージェントが memory_govern を呼び出し](../img/agent-govern.png)
...
![エージェントが memory_agent_brief を呼び出し](../img/agent-brief.png)
...
![エージェントが memory_stats を呼び出し](../img/agent-stats.png)
