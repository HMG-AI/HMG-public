...
![에이전트가 memory_memorize 호출](../img/agent-memorize.png)
...
![에이전트가 memory_recall 호출](../img/agent-recall.png)
...
![에이전트가 memory_correct 호출](../img/agent-correct.png)
...
![에이전트가 memory_govern 호출](../img/agent-govern.png)
...
![에이전트가 memory_agent_brief 호출](../img/agent-brief.png)
...
![에이전트가 memory_stats 호출](../img/agent-stats.png)
